...
export default function Womens() {
  ...
  const q = query(collection(db, "store-products"), where("category", "==", "womens"));
  ...
  return (
    <div style={{paddingTop:"0px", display:"flex", flexDirection:"row"}}>
       <div style={{display:"flex", flexDirection:"column", width:"400px", paddingLeft:"50px", backgroundColor:"lightgray"}}>
      ...
      <div style={{marginLeft:'100px', marginTop:"100px"}}>
        <div style={{color:"gray", marginBottom:"10px"}}>Home/Women</div>
        <div style={{fontSize:"50px", marginLeft:"0px"}}>Women</div>
